...
func NewTFHandler(provider *schema.Provider, nativeType string, resourceType px.Type) *GenericTFHandler {
	return &GenericTFHandler{provider, nativeType, resourceType}
}
